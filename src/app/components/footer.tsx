...
export default function Footer(){
  return (
    <div className='w-full min-h-[40vh] bg-[#1F7D72] shadow-inner flex flex-row justify-center text-[#f2f2f2] py-6 px-8'>
       ...
       <div className="flex flex-col">
         <h2 className='text-lg text-white font-semibold capitalize py-1'>help & support</h2>
          <Link target="_blank" className='text-md font-sans capitalize hover:font-medium hover:text-gray5' href='https://merchant.razorpay.com/policy/NefnUNyDO32m8f/privacy'>
            privacy policy
          </Link>
